...
.contenedornos p{
    ...
    <body>
        <%
            ArrayList<Carta> cartas =(ArrayList<Carta>)request.getAttribute("agre");
        %>
        ...
        <div class="contenedornosprincp">      
            <div class="contenedornos">
                ...
                <table class="table table-striped">
                    ...
                    <%}%>
                    <tr>
                        <td colspan="5" style="width:100%;"><center><a href="menu">Agregar</a></center></td>
                    </tr>
                </table>
            </div>
        </div>
